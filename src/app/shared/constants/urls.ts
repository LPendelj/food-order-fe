...
const BASE_URL = environment.production ? 'https://food-order-backend-w9fd.onrender.com' : 'http://localhost:5000';
...
export const ORDERS_CURRENT_USER_URL = ORDERS_URL + '/newOrderForCurrentUser'
